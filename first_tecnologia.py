...
db = mysql.connector.connect(host="us-east.connect.psdb.cloud", user="827p8rudksbcq2323llv", passwd="pscale_pw_kAhcMv0bBzMUm2ly01GdsrvrIFZB7R9EpzV5xtd02t5", database ="lapolar")
